    ...
    return (
        <div className="min-h-screen bg-gray-50 py-8">
            <div className="max-w-7xl mx-auto px-4">
                {/* Layout Wikipedia-style: Nội dung bên trái, Ảnh bên phải */}
                <div className="flex flex-col lg:flex-row gap-6">
                    ...
                    <div className="flex-1 lg:max-w-3xl">
                        ...
                        {/* Có thể thêm nội dung mô tả khác ở đây */}
                        <div className="mt-6 text-gray-700 leading-relaxed">
                            ...
                            {/* Thêm nội dung mô tả chi tiết ở đây nếu có */}
                        </div>

                        {/* Bảng thông số - Wikipedia style */}
                    ...
                    {/* Cột bên phải - Gallery ảnh (Wikipedia infobox style) */}
                    <div className="lg:w-80 flex-shrink-0">
                        <div className="bg-white border border-gray-300 rounded-lg overflow-hidden sticky top-4">
                            {/* Ảnh chính */}
                            {selectedImage && (
